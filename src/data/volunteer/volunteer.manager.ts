...
export class VolunteerManager {
   ...
   */
  private constructor(repo: VolunteerOpportunityRepository, permissionsManager: AuthorizationManager) {
    this._repo = repo;
  ...
  public async getOpportunitiesCount(
    options: VolunteerOpportunityQueryCriteria | VolunteerOpportunityQueryBuilder = {}
  ): Promise<number> {
    ...
    try {
      const builder = VolunteerOpportunityQueryBuilder.from(options).configureForCount();
   ...
   */
  public async getOpportunityById(opportunityId: string): Promise<VolunteerOpportunity | undefined> {
    ...
    try {
      ...
      console.error(`Error retrieving volunteer opportunity by ID (${opportunityId}):`, error);
      throw error;
    }
  }
   ...
   */
  public async createOpportunity(data: CreateVolunteerOpportunityDTO): Promise<VolunteerOpportunity> {
  ...
  public async updateOpportunity(
    ...
    try {
      ...
      console.error(`Error updating volunteer opportunity (${opportunityId}):`, error);
      throw error;
    }
  }
  ...
  public async deleteOpportunity(opportunityId: string): Promise<VolunteerOpportunity> {
    ...
    try {
      ...
      console.error(`Error deleting volunteer opportunity (${opportunityId}):`, error);
      throw error;
    }
  }
}
