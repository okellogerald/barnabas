...
export class UserManager {
    ...
    public async getUserById(userId: string): Promise<User | undefined> {
        if (
            !this._permManager.canPerformAction(Actions.USER_FIND_BY_ID)
        ) {
    ...
    public async updateUser(
        ...
        if (
            !this._permManager.canPerformAction(Actions.USER_UPDATE)
        ) {
    ...
    public async deleteUser(userId: string): Promise<void> {
        if (
            !this._permManager.canPerformAction(Actions.USER_DELETE)
        ) {
