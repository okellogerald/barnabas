...
export const MemberCreateChurchInfoSchema = z.object({
    ...
    nearestMemberName: CommonSchemas.name.optional()
        .describe(
 ...
 */
export const REQUIRED_MEMBER_CREATE_CHURCH_INFO_FORM_FIELDS:
    (keyof MemberCreateChurchInfo)[] = [
        "memberRole",
        "fellowshipId",
    ];
 ...
 */
export const MemberCreateEnhancedChurchInfoSchema = MemberCreateChurchInfoSchema
    .refine(
        (data) => {
