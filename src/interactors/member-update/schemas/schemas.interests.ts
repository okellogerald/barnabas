 ...
 */
export type MemberCreateInterestsInfo = z.infer<
    typeof MemberCreateInterestsInfoSchema
>;

export const MEMBER_CREATE_INTERESTS_INFO_FORM_FIELDS:
    (keyof MemberCreateInterestsInfo)[] = [
        "interests",
    ];
