...
export const useProfessionalFields = () => {
    const [form] = Form.useForm<ProfessionalInfo>();
    const builder = useSchemaFormBuilder(ProfessionalInfoSchema)
    ...
    const createFields = useCallback((): SchemaFormFieldsMap<ProfessionalInfo, ProfessionalInfoKeys> => {
        return {
