 ...
 */
export type MemberCreateContactInfo = z.infer<
    typeof MemberCreateContactInfoSchema
>;

/**
 * List of fields required on the contact information form
 */
export const REQUIRED_MEMBER_CREATE_CONTACT_INFO_FORM_FIELDS:
    (keyof MemberCreateContactInfo)[] = [
        "phoneNumber",
    ];
...
export const MEMBER_CREATE_CONTACT_INFO_FORM_FIELDS:
    (keyof MemberCreateContactInfo)[] = [
        "phoneNumber",
        "email",
        "residenceNumber",
