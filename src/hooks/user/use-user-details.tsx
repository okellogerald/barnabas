...
export const useUserDetails = () => {
    ...
    // Check permissions
    const canEditUser = AuthenticationManager.instance.hasPermission(Actions.USER_UPDATE);
    const canDeleteUser = AuthenticationManager.instance.hasPermission(Actions.USER_DELETE);
