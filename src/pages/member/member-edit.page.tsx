  ...
  const CardTitle = () => {
    return (
      <Typography.Title level={5} style={{ margin: 0 }}>
        {member ? `Editing Member: ${member.getFullName()}` : 'New Member'}
      </Typography.Title>
    );
  }

  return (
    <Card title={<CardTitle />} style={{ margin: '20px' }} loading={ui.loading}
      extra={[
        <Button onClick={() => actions.navigateToMemberDetails()}>Go to Member Details</Button>
      ]}
    >
